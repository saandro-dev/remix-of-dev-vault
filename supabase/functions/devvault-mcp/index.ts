/**
 * devvault-mcp/index.ts — Universal MCP Server for AI Agents (v5.3).
 *
 ...
 * are single-threaded.
 *
 * Tools (22): devvault_bootstrap, devvault_search, devvault_get,
 ...
 *             devvault_load_context, devvault_quickstart, devvault_changelog,
 *             devvault_diary_bug, devvault_diary_resolve, devvault_diary_list.
 */
